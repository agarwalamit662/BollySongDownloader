...
import com.support.android.musicindia.helper.Constants;
...
public class MusicServiceTinyPlayer extends Service implements OnCompletionListener {
...
/**
	...
	public void onCreate() {
		...
		quitPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.musicindia.musicplayer.quit"), 0);
		previousPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.musicindia.musicplayer.previous"), 0);
		playpausePendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.musicindia.musicplayer.playpause"), 0);
		nextPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.musicindia.musicplayer.next"), 0);
		...
		//pendingIntent = PendingIntent.getActivity(this, 0, new Intent(this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP), PendingIntent.FLAG_UPDATE_CURRENT);
...
/*shakeListener = new ShakeListener(this);
		...
		intentFilter.addAction("com.support.android.musicindia.musicplayer.quit");
		intentFilter.addAction("com.support.android.musicindia.musicplayer.previous");
		intentFilter.addAction("com.support.android.musicindia.musicplayer.previousNoRestart");
		intentFilter.addAction("com.support.android.musicindia.musicplayer.playpause");
		intentFilter.addAction("com.support.android.musicindia.musicplayer.next");
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch(action) {
                    case "com.support.android.musicindia.musicplayer.quit":

						if(!isPlaying()){
							notificationManager.cancel(Constants.NOTIFICATION_MAIN);

							stopForeground(true);
							sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.quitactivity"));
							sendBroadcast(new Intent(Intent.ACTION_CLOSE_SYSTEM_DIALOGS));
							//stopSelf();
						}

                        return;
                    case "com.support.android.musicindia.musicplayer.previous":
                        previousItem(false);
                        break;
                    case "com.support.android.musicindia.musicplayer.previousNoRestart":
                        previousItem(true);
                        break;
                    case "com.support.android.musicindia.musicplayer.playpause":
                        playPause();
                        break;
                    case "com.support.android.musicindia.musicplayer.next":
                        nextItem();
                        break;
...
/*PlaylistSong savedSong = Playlists.getSavedSongFromPlaylist(lastPlayingSongFromPlaylistId);
        			...
        			BrowserSong song = new BrowserSong(lastPlayingSong);
        			playItem(song, false);
        		}
	...
	public boolean playItem(PlayableItem item, boolean startPlaying) {
		...
		if (mediaPlayer != null) {
			...
			try {
				...
				startForeground(Constants.NOTIFICATION_MAIN, notification);
				if (startPlaying) {
					sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.newsong")); // Sends a broadcast to the activity
				}
...
/* Update notification *//*
		...
		*/
        ...
        if(Build.VERSION.SDK_INT >= 21) {
			...
			notificationBuilder.setColor(getResources().getColor(R.color.notifBuilder));
			int[] param = {1,3};
            notificationBuilder.setStyle(new Notification.MediaStyle().setShowActionsInCompactView(param));
            ...
            if (currentPlayingItem == null) {
                ...
                notificationLayout.setImageViewBitmap(R.id.imageViewNotification, BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher));
            } else {
    ...
    private void sendPlayingStateBroadcast() {
        ...
        if(currentPlayingItem!=null && (currentPlayingItem instanceof BrowserSong )) {
...
/* Toggles play/pause status. */
	...
	public void playPause() {
		...
		if(mediaPlayer != null){
			...
			updateNotificationMessage();
			sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.playpausechanged"));
		}
...
/* Plays the next song */
	...
	public void nextItem() {
		...
		if(nextItem==null) {
            ...
            sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.newsong")); // Notify the activity that there are no more songs to be played
            updateNotificationMessage();
		} else {
			playItem(nextItem);
		}
	...
	public class MusicBinder extends Binder {
		public MusicServiceTinyPlayer getService() {
			return MusicServiceTinyPlayer.this;
		}
	}
	...
	public static class MediaButtonReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
				context.sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.playpause"));
				return;
			case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
				context.sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.previousNoRestart"));
				return;
			case KeyEvent.KEYCODE_MEDIA_NEXT:
				context.sendBroadcast(new Intent("com.support.android.musicindia.musicplayer.next"));
				return;
			}
		}
	}
