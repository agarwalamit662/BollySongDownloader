...
import com.support.android.tinyplayer.model.SongsLyrics;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            boolean splashflag = extras.getBoolean("splashflag");
            splashLoadedTiny = splashflag;
            Log.e("SplashLoaded: ",String.valueOf(splashLoadedTiny));
            Log.e("SplashLoaded: ",String.valueOf(splashLoadedTiny));
        }
