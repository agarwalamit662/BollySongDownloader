...
/**
	...
	public void onCreate() {
		...
		quitPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.tinyplayer.musicplayer.quit"), 0);
		previousPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.tinyplayer.musicplayer.previous"), 0);
		playpausePendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.tinyplayer.musicplayer.playpause"), 0);
		nextPendingIntent = PendingIntent.getBroadcast(this, 0, new Intent("com.support.android.tinyplayer.musicplayer.next"), 0);
...
/*shakeListener = new ShakeListener(this);
		...
		intentFilter.addAction("com.support.android.tinyplayer.musicplayer.quit");
		intentFilter.addAction("com.support.android.tinyplayer.musicplayer.previous");
		intentFilter.addAction("com.support.android.tinyplayer.musicplayer.previousNoRestart");
		intentFilter.addAction("com.support.android.tinyplayer.musicplayer.playpause");
		intentFilter.addAction("com.support.android.tinyplayer.musicplayer.next");
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch(action) {
                    case "com.support.android.tinyplayer.musicplayer.quit":

						if(!isPlaying()){
							notificationManager.cancel(Constants.NOTIFICATION_MAIN);

							stopForeground(true);
							sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.quitactivity"));
							sendBroadcast(new Intent(Intent.ACTION_CLOSE_SYSTEM_DIALOGS));
							//stopSelf();
						}

                        return;
                    case "com.support.android.tinyplayer.musicplayer.previous":
                        previousItem(false);
                        break;
                    case "com.support.android.tinyplayer.musicplayer.previousNoRestart":
                        previousItem(true);
                        break;
                    case "com.support.android.tinyplayer.musicplayer.playpause":
                        playPause();
                        break;
                    case "com.support.android.tinyplayer.musicplayer.next":
                        nextItem();
                        break;
	...
	public boolean playItem(PlayableItem item, boolean startPlaying) {
		...
		if (mediaPlayer != null) {
			...
			try {
				...
				startForeground(Constants.NOTIFICATION_MAIN, notification);
				if (startPlaying) {
					sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.newsong")); // Sends a broadcast to the activity
				}
...
/* Toggles play/pause status. */
	...
	public void playPause() {
		...
		if(mediaPlayer != null){
			...
			updateNotificationMessage();
			sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.playpausechanged"));
		}
...
/* Plays the next song */
	...
	public void nextItem() {
		...
		if(nextItem==null) {
            ...
            sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.newsong")); // Notify the activity that there are no more songs to be played
            updateNotificationMessage();
		} else {
			playItem(nextItem);
		}
	...
	public static class MediaButtonReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
				context.sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.playpause"));
				return;
			case KeyEvent.KEYCODE_MEDIA_PREVIOUS:
				context.sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.previousNoRestart"));
				return;
			case KeyEvent.KEYCODE_MEDIA_NEXT:
				context.sendBroadcast(new Intent("com.support.android.tinyplayer.musicplayer.next"));
				return;
			}
		}
	}
